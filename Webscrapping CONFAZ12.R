...
#-----------------------------------------------------#
#------ NA PAGINA HA 3 CAMPOS DE PREENCHIMENTO: ------#
#-----------------------------------------------------#
#   - ANO
#     De 1996 ate presente ('1996, ..., 201X')
#   
#   - TIPO
#     Valores correntes ('valores_correntes')
#     Variação em relacao ao mes anterior ('variacao_relacao_mes_anterior')
#     Participacao relativa ('participacao_relativa')
#     
#   - CONTA (TIPO = Valores correntes)
#     Arrecadacao do ICMS ('icms_total')
#     Arrecadacao do IPVA ('outros_tributos_ipva')
#     Arrecadacao do ITCD ('outros_tributos_itcd')
#     Arrecadacao do TAXAS ('outros_tributos_taxas')
#     Arrecadacao de OUTROS ('outros_tributos_outros')
#     Arrecadacao de Outros Tributos ('outros_tributos_total')
#     ICMS - Setor Primario ('icms_primario')
#     ICMS - Setor Secundario ('icms_secundario')
#     ICMS - Setor Terciario ('icms_terciario')
#     ICMS - Setor Terciario - Com. Atacadista ('icms_terciario_atacadista')
#     ICMS - Setor Terciario - Com. Varejista ('icms_terciario_varejista')
#     ICMS - Setor Terciario - Serv. Transportes ('icms_terciario_transporte')
#     ICMS - Setor Terciario - Serv. Comunicacao ('icms_terciario_comunicacao')
#     ICMS - Setor Terciario - Outros ('icms_terciario_outros')
#     ICMS - Energia Eletrica ('icms_energia')
#     ICMS - Energia Eletrica - Setor Secundario ('icms_energia_secundario')
#     ICMS - Energia Eletrica - Setor Terciario ('icms_energia_terciario')
#     ICMS - Petroleo, comb. e Lub. ('icms_combustiveis')
#     ICMS - Petroleo, comb. e Lub. - Setor Secundário ('icms_combustiveis_secundario')
#     ICMS - Petroleo, comb. e Lub. - Setor Terciário ('icms_combustiveis_terciario')
